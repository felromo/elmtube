...
/***/ function(module, exports, __webpack_require__) {
	...
	var YTSearch = __webpack_require__ (2);
...
/***/ function(module, exports) {
	...
	var _user$project$MyCss$RelatedFooter = {ctor: 'RelatedFooter'};
	var _user$project$MyCss$RelatedImg = {ctor: 'RelatedImg'};
	var _user$project$MyCss$RelatedTitle = {ctor: 'RelatedTitle'};
	var _user$project$MyCss$RelatedLi = {ctor: 'RelatedLi'};
	var _user$project$MyCss$CommentContentText = {ctor: 'CommentContentText'};
	var _user$project$MyCss$CommentContentUserName = {ctor: 'CommentContentUserName'};
	var _user$project$MyCss$CommentContent = {ctor: 'CommentContent'};
	var _user$project$MyCss$CommentUserImage = {ctor: 'CommentUserImage'};
	var _user$project$MyCss$CommentFooter = {ctor: 'CommentFooter'};
	var _user$project$MyCss$CommentLi = {ctor: 'CommentLi'};
	var _user$project$MyCss$CommentsArea = {ctor: 'CommentsArea'};
	var _user$project$MyCss$VideoDescription = {ctor: 'VideoDescription'};
	var _user$project$MyCss$VideoTitle = {ctor: 'VideoTitle'};
	var _user$project$MyCss$VideoDetails = {ctor: 'VideoDetails'};
	var _user$project$MyCss$VideoFrame = {ctor: 'VideoFrame'};
	var _user$project$MyCss$ActiveVideo = {ctor: 'ActiveVideo'};
	var _user$project$MyCss$SearchForm = {ctor: 'SearchForm'};
	var _user$project$MyCss$SearchBar = {ctor: 'SearchBar'};
	var _user$project$MyCss$HeadTitle = {ctor: 'HeadTitle'};
	var _user$project$MyCss$NavBar = {ctor: 'NavBar'};
	var _user$project$MyCss$Footer = {ctor: 'Footer'};
	var _user$project$MyCss$SideBar = {ctor: 'SideBar'};
	var _user$project$MyCss$Main = {ctor: 'Main'};
	var _user$project$MyCss$Nav = {ctor: 'Nav'};
	var _user$project$MyCss$Header = {ctor: 'Header'};
	var _user$project$MyCss$Wrap = {ctor: 'Wrap'};
	var _user$project$MyCss$css = function (_p0) {
		return _rtfeldman$elm_css$Css$stylesheet(
			A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'base', _p0));
	}(
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Css_Elements$body(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_rtfeldman$elm_css$Css$property, 'font-family', 'Roboto, sans-serif'),
								_1: {ctor: '[]'}
							}
						}
					}
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												...
												_user$project$MyCss$Footer,
												{
													ctor: '::',
													_0: A2(_rtfeldman$elm_css$Css$property, 'clear', 'both'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: A2(
															...
															_user$project$MyCss$SearchForm,
															{
																ctor: '::',
														...
														_1: {
															...
															_0: A2(
																...
																_user$project$MyCss$ActiveVideo,
																{
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Css$textAlign(_rtfeldman$elm_css$Css$center),
																	_1: {ctor: '[]'}
															...
															_1: {
																...
																_0: A2(
																	...
																	_user$project$MyCss$VideoFrame,
																	{
																		ctor: '::',
																...
																_1: {
																	...
																	_0: A2(
																		...
																		_user$project$MyCss$VideoDetails,
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$backgroundColor(
																				_rtfeldman$elm_css$Css$hex('dedada')),
																			_1: {
																				ctor: '::',
																	...
																	_1: {
																		...
																		_0: A2(
																			...
																			_user$project$MyCss$VideoTitle,
																			{
																				ctor: '::',
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				_user$project$MyCss$VideoDescription,
																				{
																					ctor: '::',
																					_0: _rtfeldman$elm_css$Css$textAlign(_rtfeldman$elm_css$Css$left),
																					_1: {ctor: '[]'}
																			...
																			_1: {
																				...
																				_0: A2(
																					...
																					_user$project$MyCss$CommentsArea,
																					{
																						ctor: '::',
																						_0: _rtfeldman$elm_css$Css$backgroundColor(
																							_rtfeldman$elm_css$Css$hex('dedada')),
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '0 10px'),
																								_1: {
																									ctor: '::',
																									_0: A2(_rtfeldman$elm_css$Css$property, 'padding', '1px 10px'),
																									_1: {ctor: '[]'}
																								}
																							}
																						}
																				...
																				_1: {
																					...
																					_0: A2(
																						...
																						_user$project$MyCss$CommentLi,
																						{
																							ctor: '::',
																							_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '30px auto'),
																							_1: {ctor: '[]'}
																						}),
																					_1: {
																						ctor: '::',
																						_0: A2(
																							...
																							_user$project$MyCss$CommentUserImage,
																							{
																								ctor: '::',
																								_0: _rtfeldman$elm_css$Css$float(_rtfeldman$elm_css$Css$left),
																								_1: {
																						...
																						_1: {
																							...
																							_0: A2(
																								...
																								_user$project$MyCss$CommentContent,
																								{
																									ctor: '::',
																									_0: _rtfeldman$elm_css$Css$float(_rtfeldman$elm_css$Css$right),
																									_1: {
																							...
																							_1: {
																								...
																								_0: A2(
																									...
																									_user$project$MyCss$CommentContentUserName,
																									{
																										ctor: '::',
																										_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '0'),
																										_1: {ctor: '[]'}
																									}),
																								_1: {
																									ctor: '::',
																									_0: A2(
																										...
																										_user$project$MyCss$CommentContentText,
																										{
																											ctor: '::',
																											_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '0'),
																											_1: {ctor: '[]'}
																									...
																									_1: {
																										...
																										_0: A2(
																											...
																											_user$project$MyCss$CommentFooter,
																											{
																												ctor: '::',
																												_0: A2(_rtfeldman$elm_css$Css$property, 'clear', 'both'),
																												_1: {ctor: '[]'}
																										...
																										_1: {
																											...
																											_0: A2(
																												...
																												_user$project$MyCss$RelatedLi,
																												{
																													ctor: '::',
																													_0: A2(_rtfeldman$elm_css$Css$property, 'margin', '10px 0'),
																													_1: {ctor: '[]'}
																												}),
																											_1: {
																												ctor: '::',
																												_0: A2(
																													...
																													_user$project$MyCss$RelatedImg,
																													{
																														ctor: '::',
																														_0: _rtfeldman$elm_css$Css$float(_rtfeldman$elm_css$Css$left),
																														_1: {ctor: '[]'}
																												...
																												_1: {
																													...
																													_0: A2(
																														...
																														_user$project$MyCss$RelatedFooter,
																														{
																															ctor: '::',
																															_0: A2(_rtfeldman$elm_css$Css$property, 'clear', 'both'),
																															_1: {ctor: '[]'}
	...
	var _user$project$Main$constructUrl = F2(
		function (query, apiKey) {
			var typeParam = A2(_elm_lang$core$Basics_ops['++'], '&type=', 'video');
			var partParam = A2(_elm_lang$core$Basics_ops['++'], '&part=', 'snippet');
			var queryParam = A2(_elm_lang$core$Basics_ops['++'], '&q=', query);
			var keyParam = A2(_elm_lang$core$Basics_ops['++'], 'key=', apiKey);
			return A2(
				_elm_lang$core$Basics_ops['++'],
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						queryParam,
						A2(_elm_lang$core$Basics_ops['++'], partParam, typeParam))));
		});
	var _user$project$Main$apiKey = 'AIzaSyAVYprfgQ03PuwwwKLNVdh6KJr2Me9XLYM';
	var _user$project$Main$composeRelated = F2(
		function (videoId, videosRaw) {
			return A2(
				_elm_lang$core$List$filterMap,
				function (video) {
					return (!_elm_lang$core$Native_Utils.eq(video.videoId, videoId)) ? _elm_lang$core$Maybe$Just(video) : _elm_lang$core$Maybe$Nothing;
				},
				videosRaw);
		});
	...
	var _user$project$Main$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('base');
	...
	var _user$project$Main$activeVideo = function (video) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _user$project$Main$class(
					{
						ctor: '::',
						_0: _user$project$MyCss$ActiveVideo,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
				...
				_0: A2(
					_elm_lang$html$Html$iframe,
					{
						...
						_0: _user$project$Main$class(
							{
								ctor: '::',
								_0: _user$project$MyCss$VideoFrame,
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(
								A2(_elm_lang$core$Basics_ops['++'], 'https://www.youtube.com/embed/', video.id)),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _user$project$Main$class(
								{
									ctor: '::',
									_0: _user$project$MyCss$VideoDetails,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
							...
							_0: A2(
								_elm_lang$html$Html$h3,
								{
									...
									_0: _user$project$Main$class(
										{
											ctor: '::',
											_0: _user$project$MyCss$VideoTitle,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(video.title),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$p,
									{
										...
										_0: _user$project$Main$class(
											{
												ctor: '::',
												_0: _user$project$MyCss$VideoDescription,
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(video.description),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
	...
	var _user$project$Main$commentsLiView = function (comment) {
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_0: _user$project$Main$class(
					{
						ctor: '::',
						_0: _user$project$MyCss$CommentLi,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _user$project$Main$class(
							{
								ctor: '::',
								_0: _user$project$MyCss$CommentUserImage,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src(comment.authorProfileImageUrl),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _user$project$Main$class(
								{
									ctor: '::',
									_0: _user$project$MyCss$CommentContent,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
							...
							_0: A2(
								_elm_lang$html$Html$h5,
								{
									...
									_0: _user$project$Main$class(
										{
											ctor: '::',
											_0: _user$project$MyCss$CommentContentUserName,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(comment.authorDisplayName),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$p,
									{
										...
										_0: _user$project$Main$class(
											{
												ctor: '::',
												_0: _user$project$MyCss$CommentContentText,
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(comment.textDisplay),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _user$project$Main$class(
									{
										ctor: '::',
										_0: _user$project$MyCss$CommentFooter,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
	...
	var _user$project$Main$commentsUlView = function (_p1) {
		return A2(
			_elm_lang$html$Html$ul,
			{
				...
				_0: _user$project$Main$class(
					{
						ctor: '::',
						_0: _user$project$MyCss$CommentsArea,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				function (comment) {
					return _user$project$Main$commentsLiView(comment);
				},
				_p1));
	};
	var _user$project$Main$commentsView = F2(
		function (comments, commentsDisabled) {
			return commentsDisabled ? A2(
				_elm_lang$html$Html$p,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Comments have been disabled for this video'),
					_1: {ctor: '[]'}
				}) : (((_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$List$length(comments),
				0) > 0) && (!commentsDisabled)) ? _user$project$Main$commentsUlView(comments) : A2(
				_elm_lang$html$Html$p,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('This video has no comments :('),
					_1: {ctor: '[]'}
				}));
		});
	...
	var _user$project$Main$Video = F6(
		function (a, b, c, d, e, f) {
			return {id: a, title: b, description: c, likes: d, dislikes: e, thumbnail: f};
		});
	var _user$project$Main$composeVideo = function (_p2) {
		var _p3 = _p2;
		var _p4 = _p3.details;
		var title = _p4.title;
		var description = _p4.description;
		var thumbnails = _p4.thumbnails;
		return A6(_user$project$Main$Video, _p3.videoId, title, description, 0, 0, thumbnails);
	};
	var _user$project$Main$ActiveVideo = F3(
		function (a, b, c) {
			return {video: a, comments: b, related: c};
		});
	var _user$project$Main$Page = F2(
		function (a, b) {
			return {nextPageToken: a, items: b};
		});
	var _user$project$Main$VideoRaw = F2(
		function (a, b) {
			return {videoId: a, details: b};
		});
	var _user$project$Main$VideoDetails = F3(
		function (a, b, c) {
			return {title: a, description: b, thumbnails: c};
		});
	var _user$project$Main$Thumbnail = F3(
		function (a, b, c) {
			return {url: a, width: b, height: c};
		});
	var _user$project$Main$placeholderVideo = A6(
		...
		0,
		0,
		A3(_user$project$Main$Thumbnail, '', 0, 0));
	var _user$project$Main$placeholderVideoRaw = A2(
		_user$project$Main$VideoRaw,
		'',
		A3(
			_user$project$Main$VideoDetails,
			'',
			'',
			A3(_user$project$Main$Thumbnail, '', 0, 0)));
	var _user$project$Main$firstVideoRaw = function (videos) {
		var first = _elm_lang$core$List$head(videos);
		var _p5 = first;
		if (_p5.ctor === 'Just') {
			return _p5._0;
		} else {
			return _user$project$Main$placeholderVideoRaw;
		}
	};
	var _user$project$Main$decodeThumbnails = A4(
		_elm_lang$core$Json_Decode$map3,
		_user$project$Main$Thumbnail,
		A2(
			_elm_lang$core$Json_Decode$at,
			{
				ctor: '::',
		...
		A2(
			...
			_elm_lang$core$Json_Decode$int));
	var _user$project$Main$decodeVideoDetails = A4(
		_elm_lang$core$Json_Decode$map3,
		_user$project$Main$VideoDetails,
		A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'description', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'thumbnails', _user$project$Main$decodeThumbnails));
	var _user$project$Main$decodeVideoRaw = A3(
		...
		A2(
			...
			_elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'snippet', _user$project$Main$decodeVideoDetails));
	var _user$project$Main$decodePage = A3(
		_elm_lang$core$Json_Decode$map2,
		_user$project$Main$Page,
		A2(_elm_lang$core$Json_Decode$field, 'nextPageToken', _elm_lang$core$Json_Decode$string),
		A2(
			_elm_lang$core$Json_Decode$field,
			'items',
			_elm_lang$core$Json_Decode$list(_user$project$Main$decodeVideoRaw)));
	var _user$project$Main$CommentPage = F2(
		function (a, b) {
			return {nextPageToken: a, items: b};
		});
	var _user$project$Main$Comment = F7(
		function (a, b, c, d, e, f, g) {
			return {id: a, authorDisplayName: b, authorProfileImageUrl: c, textDisplay: d, likeCount: e, publishedAt: f, totalReplyCount: g};
		});
	var _user$project$Main$decodeComment = A8(
		...
		A2(
			...
			_elm_lang$core$Json_Decode$int));
	var _user$project$Main$decodeCommentPage = A3(
		_elm_lang$core$Json_Decode$map2,
		_user$project$Main$CommentPage,
		_elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode$field, 'nextPageToken', _elm_lang$core$Json_Decode$string)),
		A2(
			_elm_lang$core$Json_Decode$field,
			'items',
			_elm_lang$core$Json_Decode$list(_user$project$Main$decodeComment)));
	var _user$project$Main$SetPage = function (a) {
		return {ctor: 'SetPage', _0: a};
	};
	var _user$project$Main$searchVideo = function (query) {
		var url = A2(_user$project$Main$constructUrl, query, _user$project$Main$apiKey);
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Main$SetPage,
			A2(_elm_lang$http$Http$get, url, _user$project$Main$decodePage));
	};
	var _user$project$Main$init = {
		...
		_0: {
			...
			searchReturn: {ctor: '[]'},
			activeVideo: A3(
				_user$project$Main$ActiveVideo,
				A6(
					_user$project$Main$Video,
					'',
					'',
		...
		_1: _user$project$Main$searchVideo('elm')
	};
	var _user$project$Main$PostComment = {ctor: 'PostComment'};
	var _user$project$Main$PopulateComments = function (a) {
		return {ctor: 'PopulateComments', _0: a};
	};
	var _user$project$Main$fetchComments = function (videoId) {
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Main$apiKey,
					A2(_elm_lang$core$Basics_ops['++'], '&part=snippet&videoId=', videoId))));
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Main$PopulateComments,
			A2(_elm_lang$http$Http$get, url, _user$project$Main$decodeCommentPage));
	};
			...
			do {
				switch (_p6.ctor) {
					...
					case 'SetPage':
						if (_p6._0.ctor === 'Ok') {
							var _p7 = _p6._0._0;
							var first = _user$project$Main$firstVideoRaw(_p7.items);
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model,
									{
										page: _p7,
										activeVideo: {
											video: _user$project$Main$composeVideo(first),
											comments: {ctor: '[]'},
											related: A2(_user$project$Main$composeRelated, first.videoId, _p7.items)
										}
									}),
								{
									ctor: '::',
									_0: _user$project$Main$fetchComments(first.videoId),
									_1: {ctor: '[]'}
								});
						} else {
							break _v2_7;
					...
					case 'PopulateComments':
						if (_p6._0.ctor === 'Ok') {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{activeVideoComments: _p6._0._0, commentsDisabled: false}),
								{ctor: '[]'});
						} else {
							if (_p6._0._0.ctor === 'BadStatus') {
								var isDisabled = _elm_lang$core$Native_Utils.eq(_p6._0._0._0.status.code, 403) ? true : false;
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											activeVideoComments: A2(
												...
												_elm_lang$core$Maybe$Just(''),
												{ctor: '[]'}),
											error: _elm_lang$core$Basics$toString(_p6._0._0)
										}),
									{ctor: '[]'});
							}
						}
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									activeVideo: {
										video: _p8,
										comments: {ctor: '[]'},
										related: A2(_user$project$Main$composeRelated, _p8.id, model.page.items)
									}
								}),
							{
								ctor: '::',
								_0: _user$project$Main$fetchComments(_p8.id),
								_1: {ctor: '[]'}
							});
					default:
						break _v2_7;
	...
	var _user$project$Main$DislikeVideo = {ctor: 'DislikeVideo'};
	var _user$project$Main$LikeVideo = {ctor: 'LikeVideo'};
	var _user$project$Main$SelectVideo = function (a) {
		return {ctor: 'SelectVideo', _0: a};
	};
	var _user$project$Main$relatedVideoView = function (video) {
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _user$project$Main$class(
					{
						ctor: '::',
						_0: _user$project$MyCss$RelatedLi,
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$SelectVideo(
							_user$project$Main$composeVideo(video))),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$img,
					{
						...
						_0: _user$project$Main$class(
							{
								ctor: '::',
								_0: _user$project$MyCss$RelatedImg,
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(video.details.thumbnails.url),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(video.details.title),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _user$project$Main$class(
									{
										ctor: '::',
										_0: _user$project$MyCss$RelatedFooter,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
	...
	var _user$project$Main$relatedVideos = function (videosRaw) {
		return A2(
			_elm_lang$html$Html$ul,
			{ctor: '[]'},
			A2(
				_elm_lang$core$List$map,
				function (videoRaw) {
					return _user$project$Main$relatedVideoView(videoRaw);
				},
				videosRaw));
	};
	...
	var _user$project$Main$searchBar = function (model) {
		return A2(
			_elm_lang$html$Html$form,
			{
				...
				_0: _user$project$Main$class(
					{
						ctor: '::',
						_0: _user$project$MyCss$SearchForm,
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_0: _user$project$Main$class(
							{
								ctor: '::',
								_0: _user$project$MyCss$SearchBar,
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
			...
			},
			{
						...
						_0: A2(
							_elm_lang$html$Html$h1,
							{
								...
								_0: _user$project$Main$class(
									{
										ctor: '::',
										_0: _user$project$MyCss$HeadTitle,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Elmtube'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$searchBar(model),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Main$activeVideo(model.activeVideo.video),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Main$commentsView, model.activeVideoComments.items, model.commentsDisabled),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$div,
								{
									...
									_0: _user$project$Main$id(
										{
											ctor: '::',
											_0: _user$project$MyCss$SideBar,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Main$relatedVideos(model.activeVideo.related),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
